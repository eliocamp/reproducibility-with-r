...
3.  If you are on linux, you'll need to configure git to save credentials for more than 15 minutes.
...
4.  Set up git so it can work with GitHUb and RStudio.\
    ...
    The tl;dr is to run this command on your R console
    ...
    Using your full name and the email you used to register to GitHub.
    Then, you need to create a Personal Access Token with
    ...
    Then run this other command to save it to your configuration:
...
5.  (Optional) In this workshop we will be using RStudio as a simple git GUI, but in the future you might want to use a more full-fledged client.
