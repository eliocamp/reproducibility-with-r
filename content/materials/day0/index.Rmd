...
To enable it, follow the instructions in [their setup guide](https://packagemanager.rstudio.com/client/#/repos/1/overview).
Don't forget to select your Linux distribution on the top right corner.
