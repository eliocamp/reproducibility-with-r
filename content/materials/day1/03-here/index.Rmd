---
title: "03 - Using here for portable paths"
weight: 2
...
-   Download the [demo project](demo_project.zip) and extract it anywhere in your computer.
-   Open the project (double click on `demo_project.Rproj`), open `report-not_here.Rmd` and try to knit it.
:::

```{r include=FALSE}
here::i_am("content/materials/day1/03-here/index.Rmd")
...
-   Change line 9 in `report.Rmd` to
...
-  Open `report.Rmd` in a new RStudio window. Make sure that you are **not** on the demo_project project. 

-  Try to run line 9.

- Create a new chunk with the code `here::here("data/penguins.csv")` and run it. Which absolute paths does it return?
:::
...
-  Add a new chunk at the beginning of the file that `here::i_am("analysis/report.Rmd")`
